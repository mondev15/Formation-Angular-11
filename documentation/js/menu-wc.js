...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">crm2-atos-mai documentation</a>
                </li>
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/ClientsModule.html" data-type="entity-link">ClientsModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-ClientsModule-b979fd00d2a8f5a7207842fcd6a07f7a"' : 'data-target="#xs-components-links-module-ClientsModule-b979fd00d2a8f5a7207842fcd6a07f7a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-ClientsModule-b979fd00d2a8f5a7207842fcd6a07f7a"' :
                                            'id="xs-components-links-module-ClientsModule-b979fd00d2a8f5a7207842fcd6a07f7a"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/CoreModule.html" data-type="entity-link">CoreModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-CoreModule-ebd608970ba0b41ddb4667903a7f8af2"' : 'data-target="#xs-components-links-module-CoreModule-ebd608970ba0b41ddb4667903a7f8af2"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-CoreModule-ebd608970ba0b41ddb4667903a7f8af2"' :
                                            'id="xs-components-links-module-CoreModule-ebd608970ba0b41ddb4667903a7f8af2"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/IconsModule.html" data-type="entity-link">IconsModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-IconsModule-5e273e87d7b5412053eec266a434092f"' : 'data-target="#xs-components-links-module-IconsModule-5e273e87d7b5412053eec266a434092f"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-IconsModule-5e273e87d7b5412053eec266a434092f"' :
                                            'id="xs-components-links-module-IconsModule-5e273e87d7b5412053eec266a434092f"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/LoginModule.html" data-type="entity-link">LoginModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-LoginModule-81504a29b56d631dbb53f6c82f59c470"' : 'data-target="#xs-components-links-module-LoginModule-81504a29b56d631dbb53f6c82f59c470"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-LoginModule-81504a29b56d631dbb53f6c82f59c470"' :
                                            'id="xs-components-links-module-LoginModule-81504a29b56d631dbb53f6c82f59c470"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/OrdersModule.html" data-type="entity-link">OrdersModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-OrdersModule-b0de13c3eca43c88e30e57899f98f880"' : 'data-target="#xs-components-links-module-OrdersModule-b0de13c3eca43c88e30e57899f98f880"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-OrdersModule-b0de13c3eca43c88e30e57899f98f880"' :
                                            'id="xs-components-links-module-OrdersModule-b0de13c3eca43c88e30e57899f98f880"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/UiModule.html" data-type="entity-link">UiModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-UiModule-770a82e318b8278c5bbd3443851a73c5"' : 'data-target="#xs-components-links-module-UiModule-770a82e318b8278c5bbd3443851a73c5"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-UiModule-770a82e318b8278c5bbd3443851a73c5"' :
                                            'id="xs-components-links-module-UiModule-770a82e318b8278c5bbd3443851a73c5"' }>
                                            <li class="link">
